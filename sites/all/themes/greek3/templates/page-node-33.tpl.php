...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php print $language->language; ?>" lang="<?php print $language->language; ?>" dir="<?php print $language->dir; ?>"  xmlns:v="urn:schemas-microsoft-com:vml">
...
<body class="<?php print $classes; ?>">
  ...
  <div id="page-wrapper"><div id="page">
    ...
    <div id="header"><div class="section clearfix">
      ...
      <?php if ($logo): ?>
        <a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>" rel="home" id="logo"><img src="/sites/all/themes/greek3/alt-logo-wine.png" alt="<?php print t('Home'); ?>" /></a>
      <?php endif; ?>
